...
function ShopQuery(){
	...
	if($agefrom!="" && $ageto!=""){
		...
		$scl.=" and ((agefrom>=$agemin and agefrom<=$agemax) or (ageto>=$agemin and ageto<=$agemax) or (agefrom<=$agemin and ageto>=$agemax)) ";
	}
	...
	$pages->setvar(array("catid" => $catid,"myord" => $myord,"myshownums" => $myshownums,"showmethod" => $showmethod,"pricefrom" => $pricefrom,"priceto" => $priceto,"agefrom" => $agefrom,"ageto" => $ageto,"showtj" => $showtj,"showbrandid" => $showbrandid,"key" => $key));
